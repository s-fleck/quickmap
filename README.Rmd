...
leaflet maps in R. In contrast so other similar packages, quickmap does not
require an `sf` or `sp` object as input, but just works with normal data.frames
or matrices that have latitude and longitude columns. 
